...
<body>
	...
	<form action="${pageContext.request.contextPath}/ClienteModificar"
		method="post">
		<table style="width: 100%; text-align: left;" border="0">
			...
			<%
			PersonaDto cliente = (PersonaDto) request.getAttribute("cli");
			...
			<%
			String url = request.getContextPath() + "/ClienteEliminar?id=" + cliente.getId();
			%>
			<tr>
				<td><button>
